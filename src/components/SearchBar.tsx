...
const SearchBar: FC<SearchBarProps> = (props: any) => {
    ...
    return (
        <div className={classNames('filter__section', className)}>
            <div className="search">
                <div className="search__icon-wrap">
                    <svg className={'search__icon'} width="14" height="14" viewBox="0 0 20 21" fill="none"
                ...
                <input className={'form-control search__input'} onChange={e => handleSearch(e.target.value)}
