const FilterHead = (props:any) => {
    const {handleResetFilter} = props

    return (
        <div className={'filter__title-wrap'}>
            <div className={'flex items-center'}>
                <svg className={'filter__icon'} width="24" height="26" version="1.1" viewBox="0 0 700 700" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
